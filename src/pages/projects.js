...
import project8 from '../../public/images/store1.png'
import project9 from '../../public/images/movie-ticket-11.png'
        ...
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                type="Website"
                title="News-blog portal"
                summary="Full-stack project created with Node.js in the back-end , in this project you can login to your account after you complete the register form, and post text articles like a blog.
                "
                img={project7}
                link="https://theblog-tgfy.onrender.com"
                github="https://github.com/bpadros/node-blog"
              />
            </div>
            ...
            <div className="col-span-12">
              <FeaturedProject
                ...
                title="React Movie Tickets Website"
